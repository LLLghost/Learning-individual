...
const studyModuleByChapter = [0, 0, 1, 3, 4, 4, 5, 6, 7, 8, 9, 9, 10, 11, 12, 13, 16, 17, 18, 19, 20, 21, 22, 23, 25, 26, 26, 27];
...
const chapterPage = (chapter) => {
  ...
  const body = `<article class="prose chapter-prose">${rewriteLinks(chapter.intro + chapter.content, chapter.url)}</article>${chapterTrainer(chapter.number)}${pager}`;
